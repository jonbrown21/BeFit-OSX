...
@interface GUIController : NSObject
{
    ...
    IBOutlet NSView * NutritionPanelDetailWinNSView;
    ...
    IBOutlet id littleGraphView;
    IBOutlet id littleGraphViewPrint;
    IBOutlet id littleGraphView2;
    IBOutlet id littleGraphView2Print;
    IBOutlet id littleGraphView3;
    IBOutlet id littleGraphView3Print;
}
...
@property (assign) IBOutlet NSPopover *healthPopover;
@property (assign) IBOutlet NSPopover *healthPopoverQtyOnly;
