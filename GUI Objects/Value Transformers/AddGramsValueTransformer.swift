//
//  AddGramsValueTransformer.swift
//  BeFit
//
...
@objc(AddGramsValueTransformer)
class AddGramsValueTransformer: ValueTransformer {
    static let name = NSValueTransformerName(rawValue: "addGrams")
    ...
    override func transformedValue(_ value: Any?) -> Any? {
        ...
        return nsNumber.stringValue.appending("g")
    }
