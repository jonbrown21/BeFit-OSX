...
//Removed since this doesn't currently work properly.   Then added back in.
...
//{
//	FoodListArrayController *arrayController;
//	arrayController = (FoodListArrayController *) FoodListController;
//
//	if(( [ arrayController libraryIsSelected ] ) && ( aColumn == 4 ))
//	{
//		return;
//	}
//	[ super _locationOfColumn: aColumn ];
//}

//- (int) numberOfColumns
//{
//	FoodListArrayController *arrayController;
//	int	trueNumberOfColumns;
//
//	arrayController = (FoodListArrayController *) FoodListController;
//	trueNumberOfColumns = [ super numberOfColumns ];
//	if( [ arrayController libraryIsSelected ] )
//	{
//		trueNumberOfColumns--;
//	}
//	return( trueNumberOfColumns );
//}
...
- (void)textDidEndEditing:(NSNotification *)aNotification
{
	...
	if(( NULL != currentlySelectedFoodLists ) && ( [ currentlySelectedFoodLists count ] > 0 ))
	{
		...
		[ mItemsCaloriesLabel setStringValue: [ currentFoodList numberOfItemsWithCaloriesString ]];
	}
}
