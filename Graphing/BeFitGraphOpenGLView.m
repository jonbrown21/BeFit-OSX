...
@implementation BeFitGraphView
    ...
    NSString *javascriptString = [NSString stringWithFormat:@"myFunction('%@','%@','%@','%d','%d','%d','%d','%@')", calString, fatString, protString, carbInteger, sugarInteger, fiberInteger, sodiumInteger, lbspref];
