...
extension Food {
    ...
    @objc var transFatValue: String {
        ...
        var userValue = round(transfat * QuantityActualValue)
    ...
    @objc var calFromDiet: Int64 {
        //let lbspref = UserDefaults.standard.integer(forKey: "goal-name")
        let originalCalorieRatingValue = calories?.int64Value ?? 0
        
        //let yourCals = caloriesLongValue
        //let result = lbspref - yourCals
