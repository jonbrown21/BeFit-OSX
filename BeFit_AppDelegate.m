...
- (IBAction) checkingUpdates:(id)sender {

#ifdef STORE
    
    NSURL *url=[NSURL URLWithString:@"https://itunes.apple.com/us/app/befit/id854891012?mt=12&ls=1"];
    
#else
    
    NSURL *url=[NSURL URLWithString:@"https://itunes.apple.com/us/app/befit/id402924047?mt=12&ls=1"];
...
- (void)onlineCheck:(NSTimer*)labelCheck
{
    ...
    if ([self checkInternet]) {
        ...
        NSImage *notConnected = [NSImage imageNamed:@"MIHSliderDotNormal.png"];
        ...
        NSImage *isConnected = [NSImage imageNamed:@"MIHSliderDotHighlighted.png"];
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [self.CalorieScrollView setPattern:[NSImage imageNamed:@"black_linen_v2.png"]];
