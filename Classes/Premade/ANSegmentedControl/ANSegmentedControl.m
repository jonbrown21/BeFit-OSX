...
- (void)drawBackgroud:(NSRect)rect
{
    ...
    if ([[self window] isKeyWindow]) {
        ...
        frameColor = [NSColor colorWithCalibratedWhite:.50 alpha:1.0] ;
    } else {
        gradient = [[NSGradient alloc] initWithStartingColor:[NSColor colorWithCalibratedWhite:1.0 alpha:1.0]
                                                 endingColor:[NSColor colorWithCalibratedWhite:1.0 alpha:1.0]];
        frameColor = [NSColor colorWithCalibratedWhite:.50 alpha:1.0] ;
    ...
    [dropShadow setShadowColor:[NSColor colorWithCalibratedWhite:.901 alpha:.75]];
	[dropShadow set];
	[path fill];
...
- (void)drawKnob:(NSRect)rect
{
    ...
    if ([[self window] isKeyWindow]) {
        gradient = [[NSGradient alloc] initWithStartingColor:[NSColor colorWithCalibratedWhite:.95 alpha:1.0]
                                                 endingColor:[NSColor colorWithCalibratedWhite:1.0 alpha:1.0]];
